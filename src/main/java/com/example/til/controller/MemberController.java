...
public class MemberController {
    ...
    @Autowired
    public MemberController(MemberService memberService, PostService postService,GuestbookService guestbookService) {
    ...
    public ResponseEntity<Map<String, Object>> showProfile(HttpSession session) {
        ...
        List<Guestbook> guestbookEntries = guestbookService.getGuestbookEntries(loggedInMember.getId());

        Map<String, Object> response = new HashMap<>();
        response.put("member", loggedInMember);
        response.put("posts", userPosts);
        response.put("guestbookEntries", guestbookEntries);
    ...
    public ResponseEntity<Map<String, Object>> viewProfile(@PathVariable("memberId") Long memberId) {
        ...
        List<Guestbook> guestbookEntries = guestbookService.getGuestbookEntries(memberId);
    ...
    @PostMapping("/profile/{memberId}/guestbook")
    public ResponseEntity<String> addGuestbookEntry(@PathVariable("memberId") Long memberId,
        ...
        if (message == null || message.isEmpty()) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("메시지를 입력해주세요.");
        }
